...
local showOffLine = e.CreateCheckBox(contentFrame, L['SHOW_OFFLINE_PLAYERS'])
...
local showMinimap = e.CreateCheckBox(contentFrame, L['SHOW_MINIMAP_BUTTON'])
...
local showTooltip = e.CreateCheckBox(contentFrame, L['SHOW_CURRENT_KEY_TOOLTIP'])
...
local mingleOffline = e.CreateCheckBox(contentFrame, L['DISPLAY_OFFLINE_BELOW_ONLINE'])
...
local announceParty = e.CreateCheckBox(contentFrame, L['ANNOUNCE_NEW_KEYS_PARTY'])
...
local announceGuild = e.CreateCheckBox(contentFrame, L['ANNOUNCE_NEW_KEYS_GUILD'])
...
local otherFaction = e.CreateCheckBox(contentFrame, L['SHOW_OTHER_FACTION'])
...
filter_descript:SetText(L['INCLUDE_RANKS_GUILD_LISTING'])
